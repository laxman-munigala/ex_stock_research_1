...
from tools.customtool import get_stock_data, get_stock_metrics, generate_stock_chart
import os
...
technical_agent = Agent(
    ...
    Your goal is to analyze the price action and technical indicators (SMA, RSI) for a given stock ticker.
...
fundamental_agent = Agent(
    ...
    description='Analyzes company financial health and market sentiment.',
    instruction="""
...
visualization_agent = Agent(
    model='gemini-3-flash-preview',
    tools=[get_stock_data, generate_stock_chart],
